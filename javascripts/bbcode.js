...
l_help = "List: [list][item]List Item[item][/list] (alt+l)";
o_help = "Ordered list: [olist][item]List Item[item][/olist]  (alt+o)";
...
bbcode = new Array();
bbtags = new Array('[b]','[/b]','[i]','[/i]','[u]','[/u]','[quote]','[/quote]','[code]','[/code]','[list]','[/list]','[olist]','[/olist]','[img]','[/img]','[url]','[/url]','[email]','[/email]','[php]','[/php]','[align=center]','[/align]','[align=left]','[/align]','[align=right]','[/align]','[youtube]','[/youtube]','[gvideo]','[/gvideo]');
imageTag = false;
